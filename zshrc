...
# NOTE: adjust for LPAI ssh connection with suitable env
# normally /etc/profile.d/env.sh is parsed in Jupyter
while IFS= read -r line; do export ${line}; done < /etc/profile.d/env.sh
conda activate base
